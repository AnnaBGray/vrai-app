...
// Using the same URL as in supabase-init.js
...
router.get('/stats', async (req, res) => {
    try {
        ...
        // Get active users count (users with submissions in last 7 days)
        ...
        const uniqueActiveUsers = activeUsers ? new Set(activeUsers.map(user => user.user_email)).size : 0;
